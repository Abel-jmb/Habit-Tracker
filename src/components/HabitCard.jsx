    ...
    `}>
      <div className="flex items-center gap-4">
        <label className="relative flex items-center cursor-pointer group">
          ...
          />
          <span className="absolute text-purple-950 opacity-0 peer-checked:opacity-100 pointer-events-none left-1.5 font-bold">
            ✓
          </span>
        </label>
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-purple-400/80 font-medium uppercase tracking-wider">
            {date}
          </p>
        </div>
      </div>
      <button
        ...
        <span className="group-hover:scale-110 block transition-transform text-xl">
          🗑️
        </span>
      </button>
    </article>
